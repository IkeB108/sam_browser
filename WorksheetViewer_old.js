  ...
  if(aWorksheetProcessIsBusy){
    ...
    if(pageView == "double"){
      /* 
        ...
        UPDATE: These notes do not work for Safari. Refer to here for solution:
        ...
        Typically, you can make a child div with a fixed aspect ratio fill its parent div without overflowing by setting its style like this:
          1. First, wrap the child in a <div> with width 100% and height 100%.
          2. Then, set the child div's style to:
            aspect-ratio: x / y;
            max-width: 100%;
